...
Clicking the hamburger icon on the upper-left corner of the landing page will enable a user to expand the menu bar, allowing access to more controls. The expanded menu bar displays a help tab, on the uppermost side, which when clicked
provides access to the help documentation.

Located on the lowermost side of the menu bar are more controls that enable urther configurations for a user account. See screenshots below:
...
| 2(d). |   Products Setup    | Clicking on this link will allow a user to launch the products page to view available products and create new.                                                                        |
...
Clicking the **Product Category** tab will open a window displaying a list of all fund product categories in the system. From this window, the details of each product category can be viewed, new product category added and removed from the
