...
Clicking the **View Batch Updates** link as shown below will open a grid table with a list of details on the updates such as actual update time as shown below:
