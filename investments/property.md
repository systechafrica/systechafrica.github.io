...
Configurations under manage category are set to aid in the management of various participants in a scheme. Click a link to open the respective window for specific configurations as shown below:
...
<img  alt="new property managers dialog box" width="80%" height="auto"  class="center"  src="../media7/image4.png">  
...
Configurations under the property's menu category are set to aid in the management of various participants in a scheme. Click a link to open the respective window for specific configurations as shown below:
...
<img  alt="new unit dialog box" width="90%" height="auto"  class="center"  src="../media7/image17.png">  
