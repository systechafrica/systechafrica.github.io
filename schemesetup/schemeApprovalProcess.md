...
Clicking the **Checklist Validation** button will open a **Schemes Document Approval** dialogue box where documents can be searched from the list, received, and downloaded as shown below.
