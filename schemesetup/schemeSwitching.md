...
After successfully creating a new scheme, the next step is to make it - the newly created scheme - the **Working Scheme**. This is done by switch from the current scheme to the new scheme in order to continue setting up other
...
<img  alt="existing users link image" width="70%" height="auto"  class="center"  src="../media2/M66.png">
