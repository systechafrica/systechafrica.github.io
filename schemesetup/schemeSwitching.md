...
-   Click the **checkboxes** to select the Schemes to be allowed for the user. Then click the button on the upper right side of the window to display a drop-down menu. Then click the **Allow Selected Schemes** button to commit the changes.
...
-   Click the drop-down menu **label 4** to select and set a scheme from the list as the working Scheme.