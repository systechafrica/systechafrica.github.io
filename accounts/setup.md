...
Configurations under the Setups menu are set to aid in the configurations of other key setups in accounts module such as payments integration with banks. Click a link to open the respective window for specific configurations as shown below:
